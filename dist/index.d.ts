...
export declare function createServer(config: ServerOptions, requestListener?: RequestListener, upgradeListener?: UpgradeListener): net.Server;
...
export declare const upgradeNotFound: (req: ServerRequest, socket: net.Socket | tls.TLSSocket, head: Buffer) => void;
